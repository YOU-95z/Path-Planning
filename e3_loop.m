...
% [x,y,z,r];
[e,obstacles,target,entry_point]=getObstacles_vessel();
...
disp(strcat(num2str(mean_error),'±',sd));
disp("max length");
...
disp(strcat(num2str(mean_length),'±',sd));
result=[max_length,min_length,mean_length,max_error,min_error,mean_error]
